...
class __MyTemplates_dfb7204425bd268aceb832cd4ed8574a extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '            <a class="btn-floating right btn-large waves-effect waves-light red"><i class="material-icons">add</i></a>
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '        </div>
