...
class __MyTemplates_d8045c12105946d9ce65439abcc22ffd extends Mustache_Template
{
...
';
        $buffer .= $indent . '                    href="';
        $value = $this->resolveValue($context->find('plugin_url'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= 'edit_instance.php"
';
